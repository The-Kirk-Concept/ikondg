		...
		<section className="bg-white text-primary">
			<HStack orientation="ltr" image="bg-what_we_do_hero">
				<div className="text-center md:text-left">
					...
					<p className="mb-0">
						Our work does not stop there. IKON Design Group will either set up
						or work with a contractor to make sure that everything is in its
						proper place. We have the know-how to incorporate furnishings,
						lighting, and custom pieces to make for a cohesive and functional
						environment.
					</p>
				</div>
			</HStack>
			...
			<HStack orientation="ltr" image="bg-vision_hero">
				<div className="text-center md:text-left mb-4">
					...
					<p>
						At IKON, we pride ourselves on offering more than just interior
						design services—we provide an unparalleled experience curated by our
						esteemed Chief Designer, Sony Coleman, and her exceptional team.
						With a unique approach that combines expertise with warmth, we
						deliver a service that sets us apart in the industry.
					</p>
					<p>
						Our comprehensive suite of services caters to both residential and
						light commercial projects, guiding clients from the initial concept
						to the final touches of completion. With meticulous attention to
						detail and a commitment to precision, we offer:
					</p>
				</div>
